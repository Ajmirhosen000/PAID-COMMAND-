...
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘗𝘖𝘞𝘌𝘙       \033[1;97m  :  \033[34;1mAJMIR-KING         \033[38;5;46m│
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/Ajkirhossain000);time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Ajmirhosen000/Approval.txt/blob/main/Approval.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am A.J. ROBOT and my boss is Ajmir Hossain.Sir this tool is paid because 100% ok id just now login\"")
